...
//echo $age;
    ...
    $sql_SortAge = "SELECT CONCAT(CONCAT(i.firstname, ' '), i.lastname) Name, g.cosc213, g.cosc219, g.cosc222, g.cosc236, g.cosc304, (g.cosc213+ g.cosc219+ g.cosc222+ g.cosc236+ g.cosc304)/5 Average
FROM grades g, userInfo i 
WHERE g.username = i.username AND
i.age >= " . $baseage . " AND i.age <= " . $upperage . "
ORDER BY Name;";
//echo $sql_SortAge;
//echo 'check';
//echo $sql_showGrade;
    $result = mysqli_query($mysqli, $sql_SortAge)or die(mysqli_error($mysqli));
//        
