...
if (!empty($_SESSION['admin_logged_in'])) {
    $displayBlock_SortAlphabet = "<h4>All user's grades</h4>";
    $displayTable;
    $alphabet = $_POST['alphabet'];
//echo $age;
    $mysqli = mysqli_connect("localhost", "cs213user", "letmein", "finalProjectDB");
    $sql_SortAlphabet = "SELECT CONCAT(CONCAT(i.firstname, ' '), i.lastname) Name, g.cosc213, g.cosc219, g.cosc222, g.cosc236, g.cosc304, (g.cosc213+ g.cosc219+ g.cosc222+ g.cosc236+ g.cosc304)/5 Average
FROM grades g, userInfo i 
WHERE g.username = i.username AND
i.firstname LIKE '" . $alphabet . "%'
ORDER BY Name;";
//echo $sql_SortAlphabet;
//echo 'check';
//echo $sql_showGrade;
    $result = mysqli_query($mysqli, $sql_SortAlphabet)or die(mysqli_error($mysqli));
